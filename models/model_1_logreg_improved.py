...
# Для дисбаланса классов можно протестировать "balanced"
CLASS_WEIGHT = None
...
# =========================
# Проверяем необходимые колонки для новых признаков
...
excluded_cols = {
    ...
    # пока оставляем исключенными как в твоем коде
    "rating_count",
    "review_count",

    # заменили на engineered feature
    "avg_bill",
    ...
    # highly correlated competition ratings
